...
export default function SellerTransactions() {
  ...
  const myTxns = useMemo(() => {
    return transactions.filter((t) => t.seller_name.includes('Santhosh') || t.seller_name === currentUser.name)
      ...
      <div className="card">
        <DataTable
          columns={[
            ...
            { header: 'Agreed Sale Amount', accessor: (t) => formatCurrencyINR(t.agreed_amount) },
            { header: 'Payment Stage', accessor: 'payment_status' },
            { header: 'Deed Ref', accessor: (t) => t.document_reference || 'SALE-DEED-2026' },
