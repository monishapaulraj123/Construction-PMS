    ...
    <>
      ...
      {confirmingPerson && (
        <ConfirmationDialog
          ...
          message={`Assign ${confirmingPerson.first_name} ${confirmingPerson.last_name} (${confirmingPerson.service || service.service_name} Specialist) to Project: ${
            project?.project_name || service.project_name || 'Selected Project'
